...
using Sr.Manager.Core.Domains.Common.Options;
...
namespace Sr.Manager.Core.Extensions.ServiceCollection;
...
public static class SwaggerSetup
{
    public static IServiceCollection AddSwagger(this IServiceCollection services)
    {
        services.AddSwaggerGen(opt =>
        {
            ...
            opt.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Sr.Manager.xml"));
            opt.IncludeXmlComments(Path.Combine(AppContext.BaseDirectory, "Sr.Manager.Service.xml"));
            ...
            opt.AddSecurityDefinition("oauth2", new OpenApiSecurityScheme
            {
                ...
                Flows = new OpenApiOAuthFlows
                {
                    AuthorizationCode = new OpenApiOAuthFlow
                    {
                        ...
                        {
                            { "Sr.Manager", "Access read/write Sr.Manager" }
                        }
                    },
