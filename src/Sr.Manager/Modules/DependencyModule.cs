using Autofac;
using Sr.Manager.Core.Interface.IDependency;
using System;
using System.Linq;
...
public class DependencyModule : Autofac.Module
{
    ...
    {
        Assembly[] currentAssemblies = AppDomain.CurrentDomain.GetAssemblies().Where(r => r.FullName != null && r.FullName.Contains("Sr.Manager")).ToArray();
